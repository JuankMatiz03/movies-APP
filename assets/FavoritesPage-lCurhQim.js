import{r as l,u as m,f as x,b as g,j as e,d as p}from"./index-BzKiVsVa.js";import{S as f,s as w}from"./search-ePIF_HBV.js";import{n as r}from"./emotion-styled.browser.esm-qrSGHlmo.js";function v(){const[i,a]=l.useState(!1),t=m(x),o=g();l.useEffect(()=>{(()=>{(t==null?void 0:t.length)==0?a(!1):a(!0)})()},[t]);const c=s=>{o(p(s))},n=r.p`
        color: white;
        font-weight: bold;
        font-size: 2rem;
    `,d=r.p`
